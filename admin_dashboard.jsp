...
<div class="d-flex" id="wrapper">
  ...
  <div id="sidebar-wrapper" style="z-index: 1">
    <div class="list-group list-group-flush bg-white" id="sidenav">
      <a href="./admin_dashboard.jsp" class="d-flex align-items-center border-bottom p-3 text-secondary home active"><i class="lni lni-home size-sm pr-4 font-24"></i>Home</a>
      <a href="./admin_login.jsp" class="d-flex align-items-center border-bottom p-3 text-secondary visoes" style="white-space: nowrap;"><i class="lni lni-files size-sm pr-4 font-24"></i>Logout</a>
    </div>
  </div>
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container">
    <p style="bottom: 0;left: 0;right: 0;text-align: center;" class="text-secondary">All Instructors</p>
       ...
       <table id="example" style="width:100%">
                ...
                <tbody>
        <%
            ResultSet rs = DBLoader.executeQuery("select * from production");
            while(rs.next())
            {
            String status = rs.getString("status");
            %>
            <tr>
                <td><img src="<%=rs.getString("logo")%>" style="width:50px"></td>
                ...
                <%
                    ...
                    {
                    %>
                    <td><button class="btn btn-success" onclick="approve('<%=rs.getString("email")%>')">Approve</button></td>
                <%
                    }
