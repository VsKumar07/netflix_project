     ...
     function login()
{
 ...
 function register()
 {
    ...
    form.append("useremail",document.getElementById("email").value);
                            ...
                            <div id="lg2" class="tab-pane">
                                <div class="login-form-container border-black">
                                    <div class="login-register-form black-style">
                                        <form action="#" method="post">
                                            <div class="login-input-box">
                                                <input type="text" id="username" name="username" name="user-name" placeholder="User Name">
                                                <input type="password" id="rpassword" name="rpassword" name="user-password" placeholder="Password">
                                                <input name="user-email" id="email" name="email" placeholder="Email" type="email">
                                            </div>
                                            <div class="button-box">
                                                <button type="button" class="register-btn btn" type="submit" onclick="register()"><span>Register</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
