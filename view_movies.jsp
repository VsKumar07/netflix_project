...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper" class='dark-mode'>
    ...
    <div class="container">
    <p style="bottom: 0;left: 0;right: 0;text-align: center;" class="text-secondary">View Movies</p>
       ...
       <table id="example" style="width:100%">
                ...
                <tbody>
        <%
            ResultSet rs = DBLoader.executeQuery("select * from netflix.category join  netflix.content where category.type= 'movie' and content.category=category.id and content.production='"+email+"'");
            while(rs.next())
            {
            %>
            <tr>
