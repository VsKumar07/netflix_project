...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper" class='dark-mode'>
    ...
    <div class="container">
    <p style="bottom: 0;left: 0;right: 0;text-align: center;" class="text-secondary">Add Episode</p>
    <form id="form1">
        <div class="row">
           
            <div class="col-md-12 col-12">
            <div class="form-group">
                <label for="name" class="text-secondary">Enter Episode Name</label>
            ...
            <div class="form-group">
                <label for="poster">Choose Episode</label>
                <input type="file" id="episode" name="episode" class="form-control" required="true" data-ruled-required="true" data-val="true">
            </div>
            ...
            <input type="button" class="btn btn-primary" value="submit" onclick="addepisode()">
    </form>
            </div>
  </div>
...
<script>
  ...
  'success'
        ...
        window.location.href='./viewepisodes.jsp?id=<%=id%>';
           }
           else
           {
                Swal.fire({
