...
//  'success'
//)
          window.location.href='./production_dashboard.jsp';
          
            }
        
    }
  }
  xhttp.open("POST", "./productionlogin", true);
  xhttp.send(form);  
}
...
//  'success'
//)
          window.location.href='./production_house_login.jsp';
          
            }
        
    }
  }
  xhttp.open("POST", "./production_register", true);
  xhttp.send(form);  
}
                                    ...
                                    <div class="login-register-form black-style">
                                        <form action="#" method="post">
                                            <div class="login-input-box">
                                                <input type="email" name="email" id="email" placeholder="Production Email">
                                            ...
                                            <div class="button-box">
                                                ...
                                                <div class="button-box">
                                                    <button type="button"  class="login-btn btn" type="button" onclick="login()"><span>Login</span></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="login-register-form black-style">
                                        <form  id="form11">
                                            <div class="login-input-box">
                                                ...
                                                <input type="text" name="user-name" id="name" name="name" placeholder="User Name">
                                                </div>
                                                     <div class="col-md-6 col-6">
                                                <input type="password" name="user-password" id="rpassword" name="rpassword" placeholder="Password">
                                                     </div>
                                                     <div class="col-md-6 col-6">
                                                <input name="user-email" placeholder="Email"  id="remail" name="remail" type="email">
                                                     </div>
                                                    <div class="col-md-6 col-6">
                                                <input name="user-address" placeholder="Address" id="address" name="address" type="text">
                                                     </div>
                                                    <div class="col-md-6 col-6">
                                                <input name="user-phone" placeholder="Phone" id="phone" name="phone" type="text">
                                                     </div>
                                                    <div class="col-md-6 col-6">
                                                <input name="user-address" placeholder="file" id="logo" name="logo" type="file">
                                                     </div>
                                                </div>
                                            </div>
                                            <div class="button-box">
                                                <button class="register-btn btn" type="button" onclick="register()"><span>Register</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
