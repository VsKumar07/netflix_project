...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper" class='dark-mode'>
    ...
    <div class="container">
    <p style="bottom: 0;left: 0;right: 0;text-align: center;" class="text-secondary">View Episode</p>
       ...
       <table id="example" style="width:100%">
                ...
                <tbody>
        <%
            ResultSet rs = DBLoader.executeQuery("select * from episodes where content_id="+id);
            while(rs.next())
            {
            %>
            <tr>
                <td><img src="<%=rs.getString("poster")%>" style="width:50px"></td>
